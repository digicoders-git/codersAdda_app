...
class TrendingCourseDetailPage extends StatefulWidget {
  final String courseId;

  TrendingCourseDetailPage({required this.courseId});

  @override
  State<TrendingCourseDetailPage> createState() => _MyCourseDetailPageState();
}

class _MyCourseDetailPageState extends State<TrendingCourseDetailPage> {
  late Course _course;
