...
class _GeneralTestsPageState extends State<GeneralTestsPage> with SingleTickerProviderStateMixin {
  ...
  void _joinQuizWithCode(String code) {
    final quiz = _availableQuizzes.firstWhere(
      (q) => q['testCode'].toString().trim().toLowerCase() == code.trim().toLowerCase(),
      orElse: () => {},
    );
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.calendar_month, color: AppColors.primaryColor, size: AppSizer.deviceSp16),
                              SizedBox(width: AppSizer.deviceWidth2),
                              Text(
                                'Starts: ${DateFormat("dd MMM yyyy, hh:mm a").format(DateTime.parse(quiz['scheduledStartTime'].toString()).toLocal())}',
                                style: TextStyle(
                                  color: AppColors.primaryColor,
                                  fontSize: AppSizer.deviceSp12,
                                  fontWeight: FontWeight.bold,
