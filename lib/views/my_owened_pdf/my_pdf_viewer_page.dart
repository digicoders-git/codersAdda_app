...
class MyPdfViewerPage extends StatelessWidget {
  final PdfItem pdf;

  const MyPdfViewerPage({Key? key, required this.pdf}) : super(key: key);
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      // Open PDF in external viewer or use pdf package
                    },
                    child: Text('Open PDF'),
                  ),
                ],
  ...
  //   // You can use packages like permission_handler, dio, etc.
  // }
